...
class EnquiryController extends AppBaseController
{
    ...
    public function __construct(EnquiryRepository $enquiryRepo)
    {
        ...
        $this->middleware('admin_permissions:add-enquiries', ['only' => ['create', 'store']]);
        $this->middleware('admin_permissions:edit-enquiries', ['only' => ['edit', 'update']]);
        $this->middleware('admin_permissions:delete-enquiries', ['only' => ['destroy']]);
        $this->middleware('admin_permissions:view-enquiries', ['only' => ['index', 'show']]);
    }
    ...
    public function store(CreateEnquiryRequest $request)
    {
        ...
        Flash::success('Enquiry added successfully.');
